...
echo "$($PSQL "SELECT name FROM games FULL JOIN teams ON teams.team_id = games.opponent_id OR teams.team_id = games.winner_id WHERE round= 'Eighth-Final' AND year = 2014 ORDER BY name;")"
